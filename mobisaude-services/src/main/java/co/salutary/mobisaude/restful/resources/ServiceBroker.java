...
import co.salutary.mobisaude.restful.message.request.MessageRequest;
...
import co.salutary.mobisaude.restful.message.response.MessageResponse;
...
public class ServiceBroker extends AbstractServiceBroker {
	...
	@Consumes("application/json;charset=utf-8")
	@Produces("application/json;charset=utf-8")
	public MessageResponse postMessage(MessageRequest request) {logger.info(new Object() {}.getClass().getEnclosingMethod().getName());	
