...
/**
 * 	MobiSaude Services
 *	Entidade para conter uma linha de Ranking V1.
 *
 */
@XmlRootElement
@XmlType(namespace = "mobile", name = "rankingV1")
public class RankingV1 implements Cloneable {
	/**
	 * Campo uf
	 */
	private String uf;
	...
	protected Object clone() throws CloneNotSupportedException {
	    RankingV1 cloned = (RankingV1)super.clone();
