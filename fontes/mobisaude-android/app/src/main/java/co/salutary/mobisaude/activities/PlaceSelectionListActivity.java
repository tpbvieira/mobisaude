...
public class PlaceSelectionListActivity extends ListActivity {

    private static final String TAG = PlaceSelectionListActivity.class.getSimpleName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        TextView lblTitulo = (TextView) findViewById(R.id.select_list_title);
